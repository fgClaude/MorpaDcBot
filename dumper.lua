...
KeyframeSequenceProvider = "Keyframes",
TestService = "TestService",
...
{pattern = "checkbox", prefix = "Checkbox", counter = "checkbox"},
{pattern = "list", prefix = "List", counter = "list"},
{pattern = "frame", prefix = "Frame", counter = "frame"},
{pattern = "panel", prefix = "Panel", counter = "panel"},
{pattern = "gui", prefix = "GUI", counter = "gui"},
{pattern = "ui", prefix = "UI", counter = "ui"},
{pattern = "library", prefix = "Library", counter = "library"},
{pattern = "library", prefix = "Lib", counter = "lib"},
{pattern = "syn", prefix = "Synapse", counter = "syn"},
{pattern = "fluxus", prefix = "Fluxus", counter = "fluxus"},
{pattern = "krnl", prefix = "Krnl", counter = "krnl"},
{pattern = "scriptware", prefix = "Scriptware", counter = "scriptware"},
{pattern = "electron", prefix = "Electron", counter = "electron"},
{pattern = "dolby", prefix = "Dolby", counter = "dolby"},
{pattern = "aurora", prefix = "Aurora", counter = "aurora"},
{pattern = "celestial", prefix = "Celestial", counter = "celestial"},
{pattern = "delta", prefix = "Delta", counter = "delta"},
{pattern = "eclipse", prefix = "Eclipse", counter = "eclipse"},
{pattern = "polaris", prefix = "Polaris", counter = "polaris"},
{pattern = "solara", prefix = "Solara", counter = "solara"},
{pattern = "solaris", prefix = "Solaris", counter = "solaris"},
{pattern = "vermillion", prefix = "Vermillion", counter = "vermillion"},
{pattern = "zenith", prefix = "Zenith", counter = "zenith"},
{pattern = "odyssey", prefix = "Odyssey", counter = "odyssey"},
{pattern = "phantom", prefix = "Phantom", counter = "phantom"},
{pattern = "sentinel", prefix = "Sentinel", counter = "sentinel"},
{pattern = "sigma", prefix = "Sigma", counter = "sigma"},
{pattern = "valor", prefix = "Valor", counter = "valor"},
{pattern = "vector", prefix = "Vector", counter = "vector"},
{pattern = "vortex", prefix = "Vortex", counter = "vortex"}
}
local aM = {}
...
-- Constant collection and string reference tracking
if #aF > 15 and not aF:match("^[\n\r\t ]+$") then
if aF:match("^[A-Za-z0-9+/=]+$") and #aF >= 20 then
...
elseif aF:match("%.lua$") or aF:match("%.luau$") then
table.insert(t.string_refs, {value = aF, hint = "Script"})
elseif aF:match("%.json$") then
table.insert(t.string_refs, {value = aF, hint = "JSON"})
elseif aF:match("%.txt$") or aF:match("%.log$") then
table.insert(t.string_refs, {value = aF, hint = "Text"})
elseif aF:match("%.mp3$") or aF:match("%.wav$") or aF:match("%.ogg$") then
table.insert(t.string_refs, {value = aF, hint = "Audio"})
elseif aF:match("%.png$") or aF:match("%.jpg$") or aF:match("%.jpeg$") or aF:match("%.gif$") then
table.insert(t.string_refs, {value = aF, hint = "Image"})
elseif aF:match("%.mp4$") or aF:match("%.webm$") then
table.insert(t.string_refs, {value = aF, hint = "Video"})
elseif aF:match("^function%s*%(") or aF:match("^local%s+function") then
table.insert(t.string_refs, {value = aF:match("%b()"):sub(2, -2) or "unknown", hint = "Function params"})
elseif aF:match("^[A-Z][a-z]+%.[A-Z][a-z]+") then
table.insert(t.string_refs, {value = aF, hint = "Class method"})
elseif aF:match("^[A-Z][a-z]+") then
table.insert(t.string_refs, {value = aF, hint = "Class name"})
elseif aF:match("^%l%l%l+") and #aF < 10 then
table.insert(t.string_refs, {value = aF, hint = "Variable name"})
end
end
return aH(aF)
...
{pattern = "fluxus", name = "Fluxus"},
{pattern = "electron", name = "Electron"},
{pattern = "synapse", name = "Synapse"},
{pattern = "krnl", name = "KRNL"},
{pattern = "delta", name = "Delta"},
{pattern = "scriptware", name = "ScriptWare"},
{pattern = "dolby", name = "Dolby"},
{pattern = "odyssey", name = "Odyssey"},
{pattern = "solara", name = "Solara"},
{pattern = "polaris", name = "Polaris"},
{pattern = "aurora", name = "Aurora"},
{pattern = "celestial", name = "Celestial"},
{pattern = "vanguard", name = "Vanguard"},
{pattern = "sentinel", name = "Sentinel"},
{pattern = "phantom", name = "Phantom"},
{pattern = "sigma", name = "Sigma"},
{pattern = "eclipse", name = "Eclipse"},
{pattern = "valor", name = "Valor"},
{pattern = "solstice", name = "Solstice"},
{pattern = "quantum", name = "Quantum"},
{pattern = "horizon", name = "Horizon"},
{pattern = "apollo", name = "Apollo"},
{pattern = "astral", name = "Astral"},
{pattern = "void", name = "Void"},
{pattern = "nebula", name = "Nebula"},
{pattern = "cosmos", name = "Cosmos"},
{pattern = "galaxy", name = "Galaxy"}
}
